...
$customer = $i;
    ...
    $operators = mt_rand(1,7);

    $insert = "INSERT INTO cards (customer_id, operators_id, number, discount, status)  VALUES ('$customer', '$operators', '$number', 0, '$status')";
...
for($i = 1; $i < 3001; $i++)
{
    ...
    if($variat < 2)
    {
        $scope = mt_rand(15000,50000) . '.' .mt_rand(10,99);
    } elseif ($variat >= 2 && $variat< 5 )
    {
        $scope = mt_rand(50001,149999) . '.' .mt_rand(10,99);
    } else
    {
        $scope = mt_rand(5000,49999) . '.' .mt_rand(10,99);
    }
...
//    $difference = floor((1554670800 - 1489266000)/mt_rand(1,1000));
    $date = random_int(1489266000,1554670800);
//    $date1 = 1489266000+$difference;
    $date1 = date('Y-m-d H:i:s', $date);




    $insert = "INSERT INTO turnover_operations (operators_id, cards_id, scope_operation, card_use, date)  VALUES ('$operators', '$cardsId', '$scope', '$cardUse', '$date1')";
...
//Генерируем операции по бонусам

//for($i = 1; $i < 3001; $i++)
//{
//    $select = "SELECT * FROM turnover_operations WHERE id='$i'";
//    $result = mysqli_query($link, $select) or die(mysqli_error($link));
...
//    if($data['card_use'] === 1)
//    {
//        $turnover_operations_id = $data['id'];
//        $bonus_amount =
//    }
//
//    $insert = "INSERT INTO bonus_operations (turnover_operations_id, bonus_amount, bonus_accrual, date)  VALUES ('$operators', '$cardsId', '$scope', '$cardUse')";
//
//    $result = mysqli_query($link, $insert) or die(mysqli_error($link));
//}
//
